...
export const diabeticPatientFiches: DiabeticPatientFiche[] = [
  {
    patientId: "PAT-001",
    lastName: "Bernard",
    firstName: "Léa",
    ...
    diabetesType: "1",
    dateDiagnosis: "2002-06-00",
    lastHbA1c: 7.2,
    lastHbA1cDate: "2026-02-15",
    targetGlucoseMin: 70,
    targetGlucoseMax: 180,
    treatmentSummary: "Insuline rapide (Humalog) avant repas, schéma basal Lantus. Pas de pompe.",
    sensorType: "Dexcom G7",
    lastCalibration: "11 mars 2026",
    treatingPhysician: "Dr Claire Lambert",
    physicianPhone: "01 23 45 67 89",
    emergencyContact: "Marc Bernard (conjoint)",
    emergencyPhone: "06 98 76 54 32",
    allergies: "Pénicilline.",
    comorbidities: "Hypothyroïdie (lévothyroxine).",
    notes: "Épisodes hypoglycémiques en fin de matinée. Télésurveillance active. Prochaine consultation : 25 mars 2026.",
  },
  {
    patientId: "PAT-002",
    lastName: "Moreau",
    ...
    diabetesType: "2",
    dateDiagnosis: "2018-03-00",
    lastHbA1c: 6.8,
    lastHbA1cDate: "2026-01-20",
    targetGlucoseMin: 70,
    targetGlucoseMax: 180,
    treatmentSummary: "Metformine, inhibiteur SGLT2. Surveillance CGM pour optimisation.",
    sensorType: "FreeStyle Libre 3",
    lastCalibration: "10 mars 2026",
    treatingPhysician: "Dr Claire Lambert",
    emergencyContact: "Sophie Moreau (épouse)",
    emergencyPhone: "06 87 65 43 21",
    comorbidities: "Hypertension artérielle.",
    notes: "Bonne adhérence. TIR récemment amélioré.",
  },
  {
    patientId: "PAT-003",
    lastName: "Roche",
    ...
    email: "nina.roche@example.com",
    diabetesType: "1",
    dateDiagnosis: "2010-09-00",
    lastHbA1c: 7.8,
    lastHbA1cDate: "2025-12-10",
    targetGlucoseMin: 70,
    targetGlucoseMax: 180,
    treatmentSummary: "Pompe à insuline (tandem), insuline rapide. CGM Dexcom G7.",
    sensorType: "Dexcom G7",
    lastCalibration: "09 mars 2026",
    treatingPhysician: "Dr Martin (diabétologue)",
    physicianPhone: "01 98 76 54 32",
    emergencyContact: "Jean Roche (père)",
    emergencyPhone: "06 44 33 22 11",
    allergies: "Aucune connue.",
    notes: "Données CGM parfois en retard. Vérifier connexion et rappel patient.",
  },
];
